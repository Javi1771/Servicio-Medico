...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log(`Ejecutando UPDATE para desactivar la especialidad con clave: ${claveespecialidad}`);
    ...
    if (claveusuario !== null) {
      ...
      await pool.request()
        ...
        `);
      console.log("Actividad 'Eliminó una especialidad' registrada en ActividadUsuarios.");
    } else {
