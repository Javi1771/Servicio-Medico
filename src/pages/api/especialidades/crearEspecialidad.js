    ...
    try {
      ...
      if (claveusuario !== null) {
        ...
        await pool.request()
          ...
          .input("idEspecialidad", sql.Int, insertedClave)
          .query(`
          ...
          `);
        console.log("Actividad 'Agregó una especialidad' registrada en ActividadUsuarios.");
      } else {
      ...
      return res.status(500).json({ message: 'Error al agregar la especialidad', error: error.message });
    }
  } else {
