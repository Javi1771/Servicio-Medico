...
export default function GenerarReceta() {
  ...
  const verificarDatosFaltantes = (data) => {
    const camposRequeridos = [
      ...
      { campo: "claveproveedor", nombre: "Clave del proveedor" },
      { campo: "folioSurtimiento", nombre: "Folio de surtimiento" },
    ];
  ...
  const obtenerDescripcionCampo = (campo) => {
    const descripciones = {
      ...
      "Clave del proveedor": "Identificador único del médico",
      "Folio de surtimiento": "Número de folio para surtir medicamentos"
    };
  ...
  const generatePdf = async (nombreEmpleado) => {
    try {
      ...
      // Insertar código de barras si está disponible
              ...
              <div className="flex-1">
                ...
                <div className="mb-4 p-4 bg-red-900/40 rounded-lg border border-red-400">
                  ...
                  <ul className="mt-2 list-disc list-inside text-red-100">
                    ...
                    <li>Datos para generar el código de barras</li>
                  </ul>
                </div>
